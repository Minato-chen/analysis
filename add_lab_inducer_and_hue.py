...
# 读取两个CSV文件
add_data = pd.read_csv('averaged_data_with_error_bars.csv')
...
add_data.to_csv('updated_averaged_data_0.csv', index=False)

print("数据处理完成，结果已保存到updated_averaged_data_0.csv")
